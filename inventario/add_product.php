...
<?php
 if(isset($_POST['add_product'])){
   $req_fields = array('product-title','product-categorie','product-quantity','buying-price', 'product-codigo' );
   ...
   if(empty($errors)){
     ...
     $query .=" name,quantity,buy_price,categorie_id,media_id,codigo,date";
     $query .=") VALUES (";
     $query .=" '{$p_name}', '{$p_qty}', '{$p_buy}', '{$p_cat}','{$media_id}','{$p_cod}', '{$date}'";
     $query .=")";
               ...
               <div class="row">
                 ...
                 <div class="col-md-4">
                   <div class="input-group">
                     ...
                     <input type="text" class="form-control" name="buying-price" placeholder="(UNIDAD,KILO,BULTO)">
